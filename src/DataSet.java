...
public class DataSet {
	...
	/***************************************************************/
	public void initialiseSample(int min, int max, double proportion) {
	//Current working position CWP this doesn't work yet
	...
	public String theSize() {
		return "var: " + noInputVar + " inst: " + noInst;
	};
